...
class __ThrottleBucket(models.Model):
    ...
    """
    bucket_name = models.CharField(max_length=255, help_text="Which rate limiting strategy does this bucket apply to?")
    ...
    class Meta:
        unique_together = [('bucket_name', 'bucket_timespan', 'bucket_offset', 'bucket_key',)]
